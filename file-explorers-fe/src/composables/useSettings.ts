...
export function applySettings(settings: AppSettings): void {
  ...
  document.documentElement.style.setProperty('--background-secondary', darkenColor(colorHex, 0.3));
  document.documentElement.style.setProperty('--element-background', darkenColor(colorHex, 0.5));
  document.documentElement.style.setProperty('--border-color', darkenColor(colorHex, 0.6));
  ...
  document.documentElement.style.setProperty('--secondary-text', secondaryTextHex);
